...
async function seedTestDb() {
  ...
  try {
    ...
    // 4. Insert fragment for snippet 1 and 2
    ...
    // 5. Insert category for snippet 1
    ...
    // 7. Insert Share Links (ID 123 and 124) pointing to Snippets
